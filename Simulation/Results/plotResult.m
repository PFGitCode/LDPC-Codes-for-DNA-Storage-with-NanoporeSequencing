...
% soft
factor = [0.75,0.80,0.85,0.90,0.95];
error0 = [0.095011,0.138911,0.180662,0.212731,0.234923];
error1 = [0.002939,0.034965,0.117265,0.190178,0.225995];
error2 = [0,3.48e-05,6.555e-04,0.0079401,0.041338533333333];
error3 = [0,7.56e-06,1.602e-04,0.0022829,0.021];
error4 = [0,2.14e-06,6.36e-05,0.001419766666667,0.014226200000000];
errorq = [0,0,0,0,0];
