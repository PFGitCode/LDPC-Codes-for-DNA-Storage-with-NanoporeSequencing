clear
decodeMethod = 'method3'; % method1, method2, method3, method4, quater
channelError = 1.04;
...
[chan1,chan2,chan_lu,checkMatrix] = pdfmSoft(matrix,mu,acc);
ext = [-30 acc 2*edge+1];
...
result_pe1 = de_irregular2D(chan1,chan2,iter,ext,mapping,stop_pe,vard,chkd,dv,dc, chan_lu,decodeMethod);
